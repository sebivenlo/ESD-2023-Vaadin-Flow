...
public class Task2 extends HorizontalLayout {
    ...
    public Task2() {
        ...
        add(todoList, createNewToDoForm());
    }
    ...
    private FormLayout createNewToDoForm() {
        ...
        binder.forField(todoDescription)
                .asRequired("Field is Required!")
                .bind(ToDoItem::getToDoDescription, ToDoItem::setDescription);
        ...
        binder.forField(todoDueDate)
                .withValidator(new DueDateValidator("Invalid Date!","HH:mm yyyy-MM-dd"))
